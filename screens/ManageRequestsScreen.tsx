...
import { Player, RequestUser, RootStackParamList } from "@/configs/global";
import { NativeStackNavigationProp } from "@react-navigation/native-stack";

type ManageRequestsScreenRouteProp = RouteProp<RootStackParamList, "Manage">;
type ManageRequestsScreenNavigationProp = NativeStackNavigationProp<
  RootStackParamList,
  "Manage"
>;
  ...
  const acceptRequest = async (userId: string) => {
    try {
      ...
      const response = await axios.post(
        "http://10.your-ip-address-here:3000/api/games/accept",
        user
      );
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Text style={[styles.headerText, { color: theme.text }]}>Manage</Text>

          <View>
            <Text style={[styles.matchFullText, { color: theme.text }]}>
              Match Full
            </Text>
          </View>
        </View>
      ...
      >
        <View>
          {option == "Requests" && (
            <View>
              {requests?.map((item: RequestUser, index) => (
                <Pressable
                  style={{
                    padding: 10,
                    marginVertical: 10,
