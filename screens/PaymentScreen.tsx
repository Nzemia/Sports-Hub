  ...
  const bookSlot = async () => {
    ...
    try {
      ...
      const paymentResponse = await axios.post(
        "http://10.your-ip-address-here:3000/api/payment/initiate",
        {
      ...
      try {
        const bookingResponse = await axios.post(
          "http://10.your-ip-address-here:3000/api/venues/book",
          {
        ...
        if (bookingResponse.status === 200) {
          ...
          if (route.params?.gameId) {
            await axios.patch(
              `http://10.your-ip-address-here:3000/api/games/${route.params.gameId}/booking-status`,
              {
                isBooked: true,
                courtNumber: route.params.selectedCourt
              }
