...
type CreateActivityNavigationProp = NativeStackNavigationProp<
  RootStackParamList,
  "Time"
>;

type goBackActivityNavigationProp = NativeStackNavigationProp<
  RootStackParamList,
  "Play"
>;
...
const CreateActivity = () => {
  ...
  const navigation2 = useNavigation<goBackActivityNavigationProp>();

  const route = useRoute<RouteProp<RootStackParamList, "Create">>();

  const [sport, setSport] = useState("");
  const [area, setArea] = useState("");
  const [taggedVenue, setTaggedVenue] = useState<Venue | null>(null);
  ...
  const createGame = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://10.your-ip-address-here:3000/api/games/createGame",
        gameData
      );
  ...
  const selectDate = (date: string | Date) => {
    ...
    setDate(typeof date === "string" ? date : date.toISOString());
  };
      ...
      >
        <ScrollView>
          ...
          <View style={{ padding: 20 }}>
            ...
            >
              <Entypo name="location" size={24} color={theme.text} />
              <View style={{ flex: 1 }}>
                <Text
                  style={[
                    styles.sportsText,
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                ...
                <TextInput
                  ...
                  placeholderTextColor={date ? theme.text : "gray"}
            ...
            {/** total players */}
            <Text style={[styles.totalPlayersText, { color: theme.text }]}>
              Total Players
            </Text>
            <View
              style={[
            ...
            >
              <AntDesign name="setting" size={24} color={theme.text} />
              <View style={{ flex: 1 }}>
                <Text
                  style={[
                    styles.createActivityText,
