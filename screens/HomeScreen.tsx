...
const HomeScreen = () => {
  ...
  const navigation = useNavigation<CalendarPlayNavigation>();

  const profileNavigation = useNavigation<ProfileNavigation>();
    ...
    return navigation.setOptions({
      ...
      headerRight: () => (
        <View style={[styles.headerRight]}>
          ...
          <Pressable onPress={() => profileNavigation.navigate("Profile")}>
            {user?.image ? (
              <Image
                source={{
                  uri: user?.image
  ...
  const fetchUser = async (setUser: Function, setUserId: Function) => {
    try {
      ...
      if (!response.data) {
        console.error("User data is empty:", response.data);
        return;
      }
      ...
      <ScrollView>
        ...
        >
          ...
          <View>
            ...
            <Text style={[styles.keepFitText, { color: theme.text }]}>
        ...
        >
          ...
          >
            <Text style={[styles.badmintonActivityText, { color: theme.text }]}>
              Activities
            </Text>
            <Pressable
              style={[
        ...
        <View style={{ padding: 13 }}>
          ...
          >
            ...
            >
              <AntDesign name={"addusergroup"} color={theme.text} size={20} />
            </View>
            <View>
              <Text
                style={[
          ...
          >
            ...
            >
              <Ionicons name={"tennisball-outline"} color={"black"} size={20} />
            </View>
            <View>
              <Text
                style={[
